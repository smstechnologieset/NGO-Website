      ...
      >
        ...
        >
          ...
          <g className="animate-spin-slow origin-center">
            <circle cx="260" cy="180" r="6" fill="#0B284C" />
            <circle cx="260" cy="100" r="7" fill="#0284C7" />
            <circle cx="260" cy="30" r="8" fill="#0077B6" />
          </g>
        </svg>
      </div>
    );
    ...
    return (
      <span className="inline-flex items-center justify-center flex-shrink-0 group-hover:scale-110 transition-transform">
        <svg
          ...
          aria-hidden="true"
        >
          <circle cx="10" cy="10" r="8.5" stroke="#0077B6" strokeWidth="1" />
          <circle cx="10" cy="10" r="5.5" stroke="#0284C7" strokeWidth="1.2" />
          <circle cx="10" cy="10" r="2.5" fill="#0B284C" />
        </svg>
      </span>
    );
  }
  ...
  if (variant === "badge") {
    return (
      ...
      >
        ...
        >
          <circle cx="20" cy="20" r="18" stroke="#0077B6" strokeWidth="1.5" strokeDasharray="4 4" />
          <circle cx="20" cy="20" r="12" stroke="#0284C7" strokeWidth="1.8" />
          <circle cx="20" cy="20" r="6" stroke="#0B284C" strokeWidth="2" fill="#0B284C" fillOpacity="0.15" />
          <circle cx="20" cy="20" r="3" fill="#0B284C" />
        </svg>
      </div>
    );
  }
  ...
  if (variant === "watermark") {
    return (
      <svg
        ...
        aria-hidden="true"
      >
        <circle cx="110" cy="110" r="100" stroke="#0077B6" strokeWidth="2" />
        <circle cx="110" cy="110" r="68" stroke="#0284C7" strokeWidth="2" />
        <circle cx="110" cy="110" r="35" stroke="#0B284C" strokeWidth="2.5" />
      </svg>
    );
  }
    ...
    >
      ...
      <div className="flex items-center gap-2 px-3 py-1 rounded-full bg-white/60 backdrop-blur-sm border border-mutedBorder/60 shadow-xs">
        <svg width="18" height="18" viewBox="0 0 18 18" fill="none" className="hover:scale-125 transition-transform">
          <circle cx="9" cy="9" r="7.5" stroke="#0077B6" strokeWidth="1" />
          <circle cx="9" cy="9" r="4.5" stroke="#0284C7" strokeWidth="1.2" />
          <circle cx="9" cy="9" r="2" fill="#0B284C" />
        </svg>
        <svg width="24" height="24" viewBox="0 0 24 24" fill="none" className="animate-spin-slow">
          <circle cx="12" cy="12" r="10.5" stroke="#0077B6" strokeWidth="1.2" strokeDasharray="3 3" />
          <circle cx="12" cy="12" r="6.5" stroke="#0284C7" strokeWidth="1.5" />
          <circle cx="12" cy="12" r="3" fill="#0B284C" />
        </svg>
        <svg width="18" height="18" viewBox="0 0 18 18" fill="none" className="hover:scale-125 transition-transform">
          <circle cx="9" cy="9" r="7.5" stroke="#0077B6" strokeWidth="1" />
          <circle cx="9" cy="9" r="4.5" stroke="#0284C7" strokeWidth="1.2" />
